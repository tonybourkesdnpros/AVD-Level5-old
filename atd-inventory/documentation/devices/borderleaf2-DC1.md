...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.26/24 | 10.255.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_SPINE1-DC1_Ethernet7 | routed | - | 172.31.255.31/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_SPINE2-DC1_Ethernet7 | routed | - | 172.31.255.33/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE3-DC1_Ethernet7 | routed | - | 172.31.255.35/31 | default | 1500 | false | - | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.0.254.8/32 |
...
| -------- | --------- | --- |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
...
| 192.0.255.3 | 65001 | default |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_A_OP_Zone |
| 10.255.251.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.0.255.9:10 | 10:10 | - | - | learned | 110 |
| Tenant_A_VMOTION | 192.0.255.9:55160 | 55160:55160 | - | - | learned | 160 |
| Tenant_B_OP_Zone | 192.0.255.9:20 | 20:20 | - | - | learned | 210-211 |
...
| Tenant_B_OP_Zone | 192.0.255.9:20 | connected |
...
router bgp 65199
   ...
   neighbor 192.0.255.1 description spine1-DC1
   neighbor 192.0.255.2 peer group EVPN-OVERLAY-PEERS
   neighbor 192.0.255.2 remote-as 65001
   neighbor 192.0.255.2 description spine2-DC1
   neighbor 192.0.255.3 peer group EVPN-OVERLAY-PEERS
   neighbor 192.0.255.3 remote-as 65001
   neighbor 192.0.255.3 description spine3-DC1
