...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_LEAF1-DC1_Ethernet2 | routed | - | 172.31.255.0/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_LEAF2-DC1_Ethernet2 | routed | - | 172.31.255.6/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF3-DC1_Ethernet2 | routed | - | 172.31.255.12/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_LEAF4-DC1_Ethernet2 | routed | - | 172.31.255.18/31 | default | 1500 | false | - | - |
| Ethernet6 | P2P_LINK_TO_BORDERLEAF1-DC1_Ethernet2 | routed | - | 172.31.255.24/31 | default | 1500 | false | - | - |
| Ethernet7 | P2P_LINK_TO_BORDERLEAF2-DC1_Ethernet2 | routed | - | 172.31.255.30/31 | default | 1500 | false | - | - |
...
!
interface Ethernet4
   description P2P_LINK_TO_LEAF3-DC1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_LEAF4-DC1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_BORDERLEAF1-DC1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description P2P_LINK_TO_BORDERLEAF2-DC1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
| 172.31.255.25 | 65199 | default |
| 172.31.255.31 | 65199 | default |
| 192.0.255.4 | 65101 | default |
| 192.0.255.5 | 65101 | default |
| 192.0.255.6 | 65102 | default |
| 192.0.255.7 | 65102 | default |
| 192.0.255.8 | 65199 | default |
| 192.0.255.9 | 65199 | default |
